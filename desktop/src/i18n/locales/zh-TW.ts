...
第 9 列 全 8 格：接著上一列，從正下方繼續向左轉，經過左下、左邊、左上，轉回接近正上方`,
  ...
  'settings.general.storagePortableTitle': "可攜模式",
  'settings.general.storagePortableDescription': "將資料保存到桌面端執行檔旁的 cc-haha-data 資料夾，移動整個安裝目錄到其他 Windows PC 後無需重新設定。",
  'settings.general.storageCustomDirPlaceholder': "選擇一個用於保存 cc-haha 資料的資料夾",
  'settings.general.storageCustomDirLabel': "自訂資料目錄",
  'settings.general.storageCustomDescription': "將桌面端資料寫入你明確選擇的資料夾。必須使用絕對路徑，且不能放在應用程式安裝目錄內。",
  'settings.general.storageCustomTitle': "使用自訂目錄",
  ...
  'settings.general.storageApplyCustom': "使用此資料夾並重新啟動",
  ...
  'settings.general.storageSwitchPortableBody': "切換後，桌面端會把資料存到執行檔旁的 cc-haha-data 資料夾。移動安裝目錄時一併移動該資料夾，即可在其他 Windows PC 上保留設定。",
  'settings.general.storageSwitchCustomBody': "切換後，桌面端會在這個自訂目錄中讀寫對話、設定、Skills、MCP、外掛、任務與快取。",
  'settings.general.storageSwitchDefaultBody': "切回系統目錄後，桌面端會重新使用 ~/.claude。自訂或可攜目錄中的資料不會被刪除，也不會自動移回。",
  ...
  'update.checksEnabledDescription': "允許自動與手動檢查、下載應用程式更新。關閉後不會發起更新器網路請求。",
  'update.checksEnabled': "檢查更新",
