...
9 行目 8 マスすべて：前の行に続き、真下から左へ回り、左下・左・左上を通って真上の手前まで`,
  ...
  'settings.general.storagePortableTitle': "ポータブルモード",
  'settings.general.storagePortableDescription': "データをデスクトップ実行ファイル横の cc-haha-data フォルダーに保存し、インストールフォルダーを別の Windows PC に移動しても再設定不要にします。",
  'settings.general.storageCustomDirPlaceholder': "cc-haha データを保存するフォルダーを選択",
  'settings.general.storageCustomDirLabel': "カスタムデータディレクトリ",
  'settings.general.storageCustomDescription': "選択した明示的なフォルダーにデスクトップデータを保存します。アプリのインストールディレクトリ外の絶対パスが必要です。",
  'settings.general.storageCustomTitle': "カスタムディレクトリを使用",
  ...
  'settings.general.storageApplyCustom': "このフォルダーを使用して再起動",
  ...
  'settings.general.storageSwitchPortableBody': "切り替え後、デスクトップアプリは実行ファイル横の cc-haha-data フォルダーにデータを保存します。インストールフォルダーと一緒に移動すると、別の Windows PC でも設定を維持できます。",
  'settings.general.storageSwitchCustomBody': "切り替え後、デスクトップアプリはこのカスタムディレクトリでセッション、設定、Skills、MCP、プラグイン、タスク、キャッシュを読み書きします。",
  'settings.general.storageSwitchDefaultBody': "切り替え後、デスクトップアプリは再び ~/.claude を使用します。カスタムまたはポータブルディレクトリ内のデータは削除・自動移動されません。",
  ...
  'update.checksEnabledDescription': "アプリ更新の自動・手動確認とダウンロードを許可します。オフにするとアップデーターのネットワークリクエストを行いません。",
  'update.checksEnabled': "更新を確認",
