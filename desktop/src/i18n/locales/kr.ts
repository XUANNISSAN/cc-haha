...
9번째 줄 8칸 전부: 앞 줄에 이어 정면 아래에서 왼쪽으로 돌아 왼쪽 아래, 왼쪽, 왼쪽 위를 지나 정면 위 직전까지`,
  ...
  'settings.general.storagePortableTitle': "휴대용 모드",
  'settings.general.storagePortableDescription': "데이터를 데스크톱 실행 파일 옆의 cc-haha-data 폴더에 저장하여 설치 폴더를 다른 Windows PC로 옮겨도 다시 설정할 필요가 없게 합니다.",
  'settings.general.storageCustomDirPlaceholder': "cc-haha 데이터를 저장할 폴더 선택",
  'settings.general.storageCustomDirLabel': "사용자 지정 데이터 디렉터리",
  'settings.general.storageCustomDescription': "선택한 명시적 폴더에 데스크톱 데이터를 저장합니다. 앱 설치 디렉터리 밖의 절대 경로여야 합니다.",
  'settings.general.storageCustomTitle': "사용자 지정 디렉터리 사용",
  ...
  'settings.general.storageApplyCustom': "이 폴더를 사용하고 다시 시작",
  ...
  'settings.general.storageSwitchPortableBody': "전환 후 데스크톱 앱은 실행 파일 옆의 cc-haha-data 폴더에 데이터를 저장합니다. 설치 폴더와 함께 옮기면 다른 Windows PC에서도 설정을 유지할 수 있습니다.",
  'settings.general.storageSwitchCustomBody': "전환 후 데스크톱 앱은 이 사용자 지정 디렉터리에서 세션, 설정, Skills, MCP, 플러그인, 작업, 캐시를 읽고 씁니다.",
  'settings.general.storageSwitchDefaultBody': "전환 후 데스크톱 앱은 다시 ~/.claude 를 사용합니다. 사용자 지정 또는 휴대용 디렉터리의 데이터는 삭제되거나 자동으로 이동되지 않습니다.",
  ...
  'update.checksEnabledDescription': "앱 업데이트의 자동 및 수동 확인과 다운로드를 허용합니다. 끄면 업데이터 네트워크 요청을 보내지 않습니다.",
  'update.checksEnabled': "업데이트 확인",
