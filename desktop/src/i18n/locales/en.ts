...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.general.storagePortableDescription': "Keep data in a cc-haha-data folder next to the desktop executable so the install folder can be moved to another Windows PC without reconfiguration.",
  'settings.general.storageCustomDirPlaceholder': "Choose a folder for cc-haha data",
  'settings.general.storageCustomDirLabel': "Custom data directory",
  'settings.general.storageCustomDescription': "Store desktop data in one explicit folder you choose. It must be an absolute path outside the app installation directory.",
  'settings.general.storageCustomTitle': "Use custom directory",
  ...
  'settings.general.storageApplyCustom': "Use This Folder and Restart",
  ...
  'settings.general.storageSwitchPortableBody': "After switching, the desktop app will store data in cc-haha-data next to the executable. Move the install folder together with that data folder to keep the app configured on another Windows PC.",
  'settings.general.storageSwitchCustomBody': "After switching, the desktop app will read and write sessions, settings, Skills, MCP, plugins, tasks, and caches in this custom directory.",
  'settings.general.storageSwitchDefaultBody': "After switching back, the desktop app will use ~/.claude again. Data in custom or portable directories is not deleted or moved back automatically.",
  ...
  'update.checksEnabledDescription': "Allow automatic and manual app update checks and downloads. Turn this off to prevent updater network requests.",
  'update.checksEnabled': "Check for updates",
